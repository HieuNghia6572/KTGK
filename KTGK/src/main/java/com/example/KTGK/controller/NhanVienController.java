...
import com.example.KTGK.services.NhanVienService;
import com.example.KTGK.services.PhongBanService;
...
public class NhanVienController {
    ...
    //test
    @PostMapping("/edit/{id}")
    public String updateNhanVien(@PathVariable("id") Long id, @Valid NhanVien nhanvien,
